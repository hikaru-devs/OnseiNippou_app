...
import com.example.OnseiNippou_app.Service.SimpleUserRegistrationService;
...
public class SimpleUserRegistrationController {

    private final SimpleUserRegistrationService simpleUserRegistrationService;

    public SimpleUserRegistrationController(SimpleUserRegistrationService simpleUserRegistrationService) {
        this.simpleUserRegistrationService = simpleUserRegistrationService;
    }
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterUserRequest request) {
        try {
        	simpleUserRegistrationService.simpleRegister(request.getEmail(), request.getPassword());
